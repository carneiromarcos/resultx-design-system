# Guia de Social Media — Profissional de Valor (PdV)
...
## 3. Tipos de Conteudo Visual

### 3.1 Frase de impacto

| Aspecto | Diretriz |
|---------|----------|
| **Layout** | Texto centralizado, fundo dark puro |
| **Elementos** | Titulo grande branco + palavra-chave em ouro + logo |
| **Tipografia** | Sora Bold 48-64px (titulo), destaque em ouro |
...
Referencia completa do pipeline automatizado: ver documentacao em `emprega-mais-pdv-smedia/`.

**Fluxo resumido:**
```
SCN-1b Planner → SCN-NEW Script → Gravacao → SCN-UPLOAD Metadata → SCN-CONTENT → [SCN-DESIGN pendente]
```

**Databases Notion:** Brainstorm de Temas, Scripts YouTube, Conteudos, Transcricoes, Artigos, CTAs, Direcionamentos por Eixo.
...
*Nota: templates visuais seguem a paleta navy+gold do PdV (material de comunicacao/brand), nao o App DS (teal/dark do produto SaaS).*
...
- [ ] Ouro como UNICA cor de destaque?

# Motion & Animation Guide — Profissional de Valor
...
O PdV nao e um site estatico, mas tambem nao e um parque de diversoes. O motion deve:
...
| **Slide In** | Gold line separadores, barras decorativas, nav ao scroll |
...
| **Lift** | -2px translateY |
| **Glow** | 30px spread, 25% opacidade ouro |
...
### 4.2 Gold Line (separadores animados)
...
| Triangulo maior (outline ouro) | 500ms | Scale up + fade in |
...
| **Dramatica** | 1000-2000ms | Hero entrance, counters, gold lines |

...
| Arquivo | Conteudo | Formato | Status |
|---------|----------|---------|--------|
| `resultx-wordmark.svg` | Wordmark completo "ResultX" | SVG | 🔴 Pendente |
| `resultx-wordmark-light.svg` | Wordmark para fundo claro | SVG | 🔴 Pendente |
| `resultx-wordmark-mono.svg` | Wordmark single-color | SVG | 🔴 Pendente |
| `resultx-monogram.svg` | Simbolo isolado (se houver) | SVG | 🔴 Pendente |
| `resultx-favicon.svg` + `32x32.png` + `256x256.png` | Favicons | SVG+PNG | 🔴 Pendente |
| `resultx-email-header-440x120.png` | Header de email (se Brevo entrar) | PNG | 🔴 Pendente |
